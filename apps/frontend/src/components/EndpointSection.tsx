    ...
    <VStack spacing={8} align="stretch">
      ...
      <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={6}>
        ...
        <EndpointCard
          ...
          onSubmit={() =>
            onApiCall(() => endpoints.users.getByEmail(params.email))
          }
        ...
        <EndpointCard
          ...
          onChange={(value) =>
            setParams((prev) => ({ ...prev, productId: value }))
          }
          onSubmit={() =>
            onApiCall(() => endpoints.products.getById(params.productId))
          }
          isDisabled={!params.productId}
        />

        <EndpointCard
          label="GET /wallets/:userId"
          paramName="userId"
          placeholder="Enter user ID"
          value={params.userId || ""}
          onChange={(value) =>
            setParams((prev) => ({ ...prev, userId: value }))
          }
          onSubmit={() =>
            onApiCall(() => endpoints.wallets.getByUserId(params.userId))
          }
        ...
        <EndpointCard
          ...
          onSubmit={() =>
            onApiCall(() =>
              endpoints.purchases.getPurchaseHistory(params.userId)
            )
          }
          isDisabled={!params.userId}
        />
